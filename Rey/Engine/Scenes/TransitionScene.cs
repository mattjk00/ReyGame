...
namespace Rey.Engine.Scenes
{
    public class TransitionScene : Scene
    {
        ...
        public void LoadNewTransition(string nxtScene)
        {
            ...
            screen.Sprite.Color = new Color(255, 255, 255, 254);
            screen.Transform.Position = Vector2.Zero;
        ...
        public override void Update(Camera2D camera)
        {
            ...
            if (this.fadeTimer > this.fadeDelay && screen.Sprite.Color.A != 255)
            {
                ...
                this.screen.Sprite.Color = Color.White; // reset it
                this.fadeTimer = 0;
            }
            ...
            if (screen.Sprite.Color.A == 255)
                screen.Transform.Position += new Vector2(0, 25);


            // after the loading screen is faded
            if (screen.Transform.Position.Y > 720)//if (screen.Sprite.Color.A == 0)
            {
        ...
        {
            sb.Draw(screen.Sprite.Texture, screen.Transform.Position, screen.Sprite.Color);
        }
    }
}
